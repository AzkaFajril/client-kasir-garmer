...
export default function KasirProfile() {
  ...
  const [step, setStep] = useState(1); // 1: Profil, 2: Form Ganti Password
  ...
  const handleChangePassword = async (e) => {
    e.preventDefault();
    if (!formData.currentPassword) return toast.error('Masukkan password saat ini!');
    if (formData.newPassword.length < 6) return toast.error('Password baru minimal 6 karakter!');
      ...
      <div className="prof-root">
        ...
        <div className="prof-card">
          ...
          <div className="prof-body">
            ...
            {step === 1 ? (
              <div>
                <p className="sec-desc">Untuk mengubah password akun Toko_Garmer Anda, masukkan password saat ini sebagai verifikasi, lalu tentukan password baru.</p>
                <button className="btn-main" onClick={() => setStep(2)} disabled={isLoading}>
              ...
              <form className="otp-form" onSubmit={handleChangePassword}>
                <div className="f-group">
                  <label className="f-label">Password Saat Ini</label>
                  <input
                    type="password" required placeholder="Masukkan password saat ini"
                    className="f-inp"
                ...
                <div className="form-acts">
                  <button type="button" className="btn-cancel" onClick={() => { setStep(1); setFormData({ currentPassword: '', newPassword: '' }); }} disabled={isLoading}>
                    Batal
                  </button>
