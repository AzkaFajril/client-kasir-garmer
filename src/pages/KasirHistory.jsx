...
export default function KasirHistory() {
  ...
  const totalRevenue = useMemo(() => {
    return filteredOrders.reduce((s, o) => s + Number(o.total || 0), 0);
  }, [filteredOrders]);
  ...
  return (
    <>
      <style>{`
        ...
        @media(max-width:640px){.hist-root{padding:14px; padding-bottom: 80px;}}
        ...
        /* FIX AGAR TABEL BISA DI-SCROLL KE BAWAH DENGAN RAPI */
        .tbl-wrap{
          max-height: 480px; /* Batasi tinggi area tabel agar scroll aktif jika data banyak */
          overflow-y: auto;   /* Memunculkan scrollbar vertikal */
          overflow-x: auto;   /* Tetap aman untuk layar kecil (horizontal scroll) */
        }
        
        /* Membuat Header Tabel tetap menempel di atas saat discroll */
        ...
        th{
          ...
          background: var(--foam); /* Warna latar belakang agar header menutupi baris saat discroll */
        }
      ...
      <div className="hist-root">
        ...
        <div className="page-header">
          ...
          <p>Laporan penjualan yang diproses oleh akun <strong style={{ color:'var(--accent)' }}>{user?.name || 'Kasir'}</strong></p>
        </div>
